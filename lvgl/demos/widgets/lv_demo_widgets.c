...
static void profile_create(lv_obj_t * parent)
{
    ...
    lv_label_set_text(name, "Engr. Toyyib Olalekan");
    lv_obj_add_style(name, &style_title, 0);

    lv_obj_t * dsc = lv_label_create(panel1);
    lv_obj_add_style(dsc, &style_text_muted, 0);
    lv_label_set_text(dsc, "Embedded systems professional, curious data scientist, lifelong learner blending technology, AI, and communication" );
    ...
    lv_label_set_text(email_label, "tybolalekan@yahoo.com.au");
    ...
    lv_label_set_text(call_label, "+234(0)813 7995 448");
